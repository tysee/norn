...
lead/lag BTC↔TON (лёгкая версия).
...
драйверов как core (остаётся experimental до evidence-gate).
...
- Где запускается MCP-сервер относительно ClickHouse и как Pi его резолвит (стабильный URL).
